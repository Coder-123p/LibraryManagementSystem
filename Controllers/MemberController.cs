...
namespace LibraryManagementSystem.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumber,Email,Address,MemberTypeId,MemberDate,MemberExpDate")] MemberModel memberModel)
        {
            ...
            ViewData["MemberTypeId"] = new SelectList(_context.MemberType, "Id", "Id", memberModel.MemberTypeId);
            return View(memberModel);
        }
